...
class DoctorController extends Controller
{
	...
	public function actionView()
	{
        ...
        $countRow = Yii::app()->db->createCommand("select count(*) from image where doctor_id='".($model->doctor_id?$model->doctor_id:-1)."'")->queryScalar();
        $query = "select id,img_url from image where doctor_id='".($model->doctor_id?$model->doctor_id:-1)."'";
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=Doctor::model()->findbyPk($_GET['id']);
			if($this->_model===null)
