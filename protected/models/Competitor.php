...
class Competitor extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('product_id, category', 'required'),
            array('product_id, image', 'numerical', 'integerOnly' => true),
            array('status', 'length', 'max' => 1),
            array('description', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('competitor_id, product_id, category, quantity, image, description', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations()
    {
        ...
        return array(
           ...
           // 'dep_competitor' => array(self::HAS_MANY, 'DepPosm', 'posm_id'),
        );
    }
    ...
    public function search()
    {
        ...
        return new CActiveDataProvider('Competitor', array(
            'criteria' => $criteria,
        ));
    }
